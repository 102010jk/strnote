...
// úhly ve stupních. Dráhy jsou kruhové, výstřednost se zatím zanedbává.

const AU = 149.5978707; // Gm

/**
 * Každé těleso:
 * - `radius` – střední poloměr
 * - `parent` – kolem čeho obíhá; `a` poloměr dráhy, `period` oběžná doba
...
export const SOLAR_SYSTEM = [
  {
    ...
    radius: 0.6957, color: [1.0, 0.93, 0.82],
    spin: 25.38, tilt: 7.25,
  },
  {
    id: 'mercury', name: 'Merkur', parent: 'sun', material: 'rock',
    radius: 0.0024397, color: [0.55, 0.53, 0.5],
  ...
  },
  {
    ...
    radius: 0.0060518, color: [0.93, 0.84, 0.62], bands: [0.06, 5],
  ...
  },
  {
    ...
    radius: 0.006371, color: [0.28, 0.48, 0.85],
  ...
  },
  {
    ...
    radius: 0.0017374, color: [0.6, 0.59, 0.57],
  ...
  },
  {
    ...
    radius: 0.0033895, color: [0.78, 0.42, 0.25],
  ...
  },
  {
    ...
    radius: 0.069911, color: [0.85, 0.72, 0.55], bands: [0.35, 16],
  ...
  },
  {
    ...
    radius: 0.058232, color: [0.9, 0.82, 0.6], bands: [0.15, 14], rings: [1.239, 2.27],
  ...
  },
  {
    ...
    radius: 0.025362, color: [0.62, 0.86, 0.9], bands: [0.04, 8],
  ...
  },
  {
    ...
    radius: 0.024622, color: [0.3, 0.48, 0.95], bands: [0.12, 10],
